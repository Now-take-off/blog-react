...
const Cover = () => {
  ...
  const handleClick = () => {
    circular.current.style.transform = 'scaleX(1.4) scaleY(1.4)'
    setTimeout(() => {
      history.push('/home')
    }, 1000)
  }
  ...
  return (
    <WrapperBox>
      ...
      <div className="title">人们对自己不懂得事，总会觉得有些害怕的。</div>
      <div ref={start} className="start" onClick={() => handleClick()}></div>
      <div ref={circular} className="circular"></div>
    </WrapperBox>
  )
}
